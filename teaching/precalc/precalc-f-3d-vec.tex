...
\end{equation*}
\end{enumerate}
\item \emph{Angles.} % use scalings of 2,2,-1 for orthogonal matrix and make 60 degree angles using unit cube tetrahedron, also ask for angle between faces of regular octahedron
